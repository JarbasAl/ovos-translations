...
def collect_locales():
    ...
    with open("hatchery_skills.txt") as f:
        for url in f.read().split("\n"):
            ...
            if not os.path.isdir(f"{tx_base}/locale"):
                continue
...
with open(f"{os.path.dirname(__file__)}/HATCHERY.md", "w") as f:
    f.write(README_TEMPLATE.format(skill_id="ovos-hatchery-translations",
